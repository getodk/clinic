...
import org.odk.clinic.android.database.FileDbAdapter;
import org.odk.clinic.android.listeners.FormLoaderListener;
import org.odk.clinic.android.listeners.FormSavedListener;
import org.odk.clinic.android.logic.PropertyManager;
import org.odk.clinic.android.tasks.FormLoaderTask;
import org.odk.clinic.android.tasks.SaveToDiskTask;
import org.odk.clinic.android.utilities.FileUtils;
import org.odk.clinic.android.utilities.GestureDetector;
import org.odk.clinic.android.views.AbstractFolioView;
import org.odk.clinic.android.views.GroupView;
import org.odk.clinic.android.views.QuestionView;
import org.odk.clinic.android.views.layout.GroupLayoutFactory;
...
public class FormEntryActivity extends Activity implements AnimationListener, FormLoaderListener,
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mHandler = new Handler(Clinic.getInstance().getMainLooper());
        ...
        if (data instanceof FormLoaderTask) {
            ...
            FormEntryController fec = Clinic.getInstance().getFormEntryController();
            if (fec != null && !newForm) {
            ...
            Clinic.getInstance().setFormEntryController(null);
    ...
    public Object onRetainNonConfigurationInstance() {
        ...
        if (Clinic.getInstance().getFormEntryController() != null && currentPromptIsQuestion()) {
            saveCurrentAnswer(false);
        }
        return null;
    }
    ...
    public void showView(View next, AnimationType from) {
        ...
        if (mCurrentView instanceof AbstractFolioView)
            ...
            Clinic.getInstance().hideSoftKeyboard(mCurrentView);
        }
    }
                        ...
                        new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int whichButton) {
                                FormEntryController fec =
                                    Clinic.getInstance().getFormEntryController();
    ...
    public void loadingComplete(FormEntryController fec) {
        ...
        Clinic.getInstance().setFormEntryController(fec);
        mFormEntryModel = fec.getModel();
