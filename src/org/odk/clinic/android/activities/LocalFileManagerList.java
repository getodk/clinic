...
public class LocalFileManagerList extends ListActivity {
    ...
    private void deleteSelectedFiles() {
        ...
        fda.removeOrphanInstances(this.getApplicationContext());
        fda.close();

        if (deleted > 0) {
            // all deletes were successful
            Toast.makeText(getApplicationContext(), getString(R.string.form_deleted_ok, deleted),
                    Toast.LENGTH_SHORT).show();
            refreshData();
            ...
            Toast.makeText(
                    ...
                    getString(R.string.form_deleted_error, mSelected.size() - deleted + " of "
