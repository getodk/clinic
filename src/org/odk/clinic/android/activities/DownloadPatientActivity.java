...
public class DownloadPatientActivity extends Activity implements DownloadListener {
    ...
    private void downloadPatients() {
        ...
        mDownloadTask.setDownloadListener(DownloadPatientActivity.this);
        mDownloadTask.execute(url, username, password, Integer.toString(cohortId));
    }
    ...
    private void getCohorts() {
        ...
        if (c != null && c.getCount() >= 0) {
            ...
            int cohortIdIndex = c.getColumnIndex(ClinicAdapter.KEY_COHORT_ID);
            int nameIndex = c.getColumnIndex(ClinicAdapter.KEY_COHORT_NAME);
    ...
    private class CohortDialogListener implements DialogInterface.OnClickListener,
