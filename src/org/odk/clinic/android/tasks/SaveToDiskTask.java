...
public class SaveToDiskTask extends AsyncTask<Void, String, Integer> {
    ...
    protected Integer doInBackground(Void... nothing) {
        ...
        Clinic.getInstance().getFormEntryController().getModel().getForm().postProcessInstance();
    ...
    public boolean exportData(String instancePath, Context context, boolean markCompleted) {
        ...
        try {
            ...
            FormInstance datamodel = Clinic.getInstance().getFormEntryController().getModel().getForm().getInstance();
